...
public class FontAwesomeBrands implements IconSet {
    ...
    public static final String FAB_500PX                          = "fab_500px";
    public static final String FAB_ACCESSIBLE_ICON                = "fab_accessible_icon";
    public static final String FAB_ACCUSOFT                       = "fab_accusoft";
    public static final String FAB_ACQUISITIONS_INCORPORATED      = "fab_acquisitions_incorporated";
    public static final String FAB_ADN                            = "fab_adn";
    public static final String FAB_ADVERSAL                       = "fab_adversal";
    public static final String FAB_AFFILIATETHEME                 = "fab_affiliatetheme";
    public static final String FAB_ALGOLIA                        = "fab_algolia";
    public static final String FAB_ALIPAY                         = "fab_alipay";
    public static final String FAB_AMAZON                         = "fab_amazon";
    public static final String FAB_AMAZON_PAY                     = "fab_amazon_pay";
    public static final String FAB_AMILIA                         = "fab_amilia";
    public static final String FAB_ANDROID                        = "fab_android";
    public static final String FAB_ANGELLIST                      = "fab_angellist";
    public static final String FAB_ANGRYCREATIVE                  = "fab_angrycreative";
    public static final String FAB_ANGULAR                        = "fab_angular";
    public static final String FAB_APP_STORE                      = "fab_app_store";
    public static final String FAB_APP_STORE_IOS                  = "fab_app_store_ios";
    public static final String FAB_APPER                          = "fab_apper";
    public static final String FAB_APPLE                          = "fab_apple";
    public static final String FAB_APPLE_PAY                      = "fab_apple_pay";
    public static final String FAB_ASYMMETRIK                     = "fab_asymmetrik";
    public static final String FAB_AUDIBLE                        = "fab_audible";
    public static final String FAB_AUTOPREFIXER                   = "fab_autoprefixer";
    public static final String FAB_AVIANEX                        = "fab_avianex";
    public static final String FAB_AVIATO                         = "fab_aviato";
    public static final String FAB_AWS                            = "fab_aws";
    public static final String FAB_BANDCAMP                       = "fab_bandcamp";
    public static final String FAB_BEHANCE                        = "fab_behance";
    public static final String FAB_BEHANCE_SQUARE                 = "fab_behance_square";
    public static final String FAB_BIMOBJECT                      = "fab_bimobject";
    public static final String FAB_BITBUCKET                      = "fab_bitbucket";
    public static final String FAB_BITCOIN                        = "fab_bitcoin";
    public static final String FAB_BITY                           = "fab_bity";
    public static final String FAB_BLACK_TIE                      = "fab_black_tie";
    public static final String FAB_BLACKBERRY                     = "fab_blackberry";
    public static final String FAB_BLOGGER                        = "fab_blogger";
    public static final String FAB_BLOGGER_B                      = "fab_blogger_b";
    public static final String FAB_BLUETOOTH                      = "fab_bluetooth";
    public static final String FAB_BLUETOOTH_B                    = "fab_bluetooth_b";
    public static final String FAB_BTC                            = "fab_btc";
    public static final String FAB_BUROMOBELEXPERTE               = "fab_buromobelexperte";
    public static final String FAB_CC_AMAZON_PAY                  = "fab_cc_amazon_pay";
    public static final String FAB_CC_AMEX                        = "fab_cc_amex";
    public static final String FAB_CC_APPLE_PAY                   = "fab_cc_apple_pay";
    public static final String FAB_CC_DINERS_CLUB                 = "fab_cc_diners_club";
    public static final String FAB_CC_DISCOVER                    = "fab_cc_discover";
    public static final String FAB_CC_JCB                         = "fab_cc_jcb";
    public static final String FAB_CC_MASTERCARD                  = "fab_cc_mastercard";
    public static final String FAB_CC_PAYPAL                      = "fab_cc_paypal";
    public static final String FAB_CC_STRIPE                      = "fab_cc_stripe";
    public static final String FAB_CC_VISA                        = "fab_cc_visa";
    public static final String FAB_CENTERCODE                     = "fab_centercode";
    public static final String FAB_CHROME                         = "fab_chrome";
    public static final String FAB_CLOUDSCALE                     = "fab_cloudscale";
    public static final String FAB_CLOUDSMITH                     = "fab_cloudsmith";
    public static final String FAB_CLOUDVERSIFY                   = "fab_cloudversify";
    public static final String FAB_CODEPEN                        = "fab_codepen";
    public static final String FAB_CODIEPIE                       = "fab_codiepie";
    public static final String FAB_CONNECTDEVELOP                 = "fab_connectdevelop";
    public static final String FAB_CONTAO                         = "fab_contao";
    public static final String FAB_CPANEL                         = "fab_cpanel";
    public static final String FAB_CREATIVE_COMMONS               = "fab_creative_commons";
    public static final String FAB_CREATIVE_COMMONS_BY            = "fab_creative_commons_by";
    public static final String FAB_CREATIVE_COMMONS_NC            = "fab_creative_commons_nc";
    public static final String FAB_CREATIVE_COMMONS_NC_EU         = "fab_creative_commons_nc_eu";
    public static final String FAB_CREATIVE_COMMONS_NC_JP         = "fab_creative_commons_nc_jp";
    public static final String FAB_CREATIVE_COMMONS_ND            = "fab_creative_commons_nd";
    public static final String FAB_CREATIVE_COMMONS_PD            = "fab_creative_commons_pd";
    public static final String FAB_CREATIVE_COMMONS_PD_ALT        = "fab_creative_commons_pd_alt";
    public static final String FAB_CREATIVE_COMMONS_REMIX         = "fab_creative_commons_remix";
    public static final String FAB_CREATIVE_COMMONS_SA            = "fab_creative_commons_sa";
    public static final String FAB_CREATIVE_COMMONS_SAMPLING      = "fab_creative_commons_sampling";
    public static final String FAB_CREATIVE_COMMONS_SAMPLING_PLUS = "fab_creative_commons_sampling_plus";
    public static final String FAB_CREATIVE_COMMONS_SHARE         = "fab_creative_commons_share";
    public static final String FAB_CREATIVE_COMMONS_ZERO          = "fab_creative_commons_zero";
    public static final String FAB_CRITICAL_ROLE                  = "fab_critical_role";
    public static final String FAB_CSS3                           = "fab_css3";
    public static final String FAB_CSS3_ALT                       = "fab_css3_alt";
    public static final String FAB_CUTTLEFISH                     = "fab_cuttlefish";
    public static final String FAB_D_AND_D                        = "fab_d_and_d";
    public static final String FAB_D_AND_D_BEYOND                 = "fab_d_and_d_beyond";
    public static final String FAB_DASHCUBE                       = "fab_dashcube";
    public static final String FAB_DELICIOUS                      = "fab_delicious";
    public static final String FAB_DEPLOYDOG                      = "fab_deploydog";
    public static final String FAB_DESKPRO                        = "fab_deskpro";
    public static final String FAB_DEV                            = "fab_dev";
    public static final String FAB_DEVIANTART                     = "fab_deviantart";
    public static final String FAB_DIGG                           = "fab_digg";
    public static final String FAB_DIGITAL_OCEAN                  = "fab_digital_ocean";
    public static final String FAB_DISCORD                        = "fab_discord";
    public static final String FAB_DISCOURSE                      = "fab_discourse";
    public static final String FAB_DOCHUB                         = "fab_dochub";
    public static final String FAB_DOCKER                         = "fab_docker";
    public static final String FAB_DRAFT2DIGITAL                  = "fab_draft2digital";
    public static final String FAB_DRIBBBLE                       = "fab_dribbble";
    public static final String FAB_DRIBBBLE_SQUARE                = "fab_dribbble_square";
    public static final String FAB_DROPBOX                        = "fab_dropbox";
    public static final String FAB_DRUPAL                         = "fab_drupal";
    public static final String FAB_DYALOG                         = "fab_dyalog";
    public static final String FAB_EARLYBIRDS                     = "fab_earlybirds";
    public static final String FAB_EBAY                           = "fab_ebay";
    public static final String FAB_EDGE                           = "fab_edge";
    public static final String FAB_ELEMENTOR                      = "fab_elementor";
    public static final String FAB_ELLO                           = "fab_ello";
    public static final String FAB_EMBER                          = "fab_ember";
    public static final String FAB_EMPIRE                         = "fab_empire";
    public static final String FAB_ENVIRA                         = "fab_envira";
    public static final String FAB_ERLANG                         = "fab_erlang";
    public static final String FAB_ETHEREUM                       = "fab_ethereum";
    public static final String FAB_ETSY                           = "fab_etsy";
    public static final String FAB_EXPEDITEDSSL                   = "fab_expeditedssl";
    public static final String FAB_FACEBOOK                       = "fab_facebook";
    public static final String FAB_FACEBOOK_F                     = "fab_facebook_f";
    public static final String FAB_FACEBOOK_MESSENGER             = "fab_facebook_messenger";
    public static final String FAB_FACEBOOK_SQUARE                = "fab_facebook_square";
    public static final String FAB_FANTASY_FLIGHT_GAMES           = "fab_fantasy_flight_games";
    public static final String FAB_FIREFOX                        = "fab_firefox";
    public static final String FAB_FIRST_ORDER                    = "fab_first_order";
    public static final String FAB_FIRST_ORDER_ALT                = "fab_first_order_alt";
    public static final String FAB_FIRSTDRAFT                     = "fab_firstdraft";
    public static final String FAB_FLICKR                         = "fab_flickr";
    public static final String FAB_FLIPBOARD                      = "fab_flipboard";
    public static final String FAB_FLY                            = "fab_fly";
    public static final String FAB_FONT_AWESOME                   = "fab_font_awesome";
    public static final String FAB_FONT_AWESOME_ALT               = "fab_font_awesome_alt";
    public static final String FAB_FONT_AWESOME_FLAG              = "fab_font_awesome_flag";
    public static final String FAB_FONTICONS                      = "fab_fonticons";
    public static final String FAB_FONTICONS_FI                   = "fab_fonticons_fi";
    public static final String FAB_FORT_AWESOME                   = "fab_fort_awesome";
    public static final String FAB_FORT_AWESOME_ALT               = "fab_fort_awesome_alt";
    public static final String FAB_FORUMBEE                       = "fab_forumbee";
    public static final String FAB_FOURSQUARE                     = "fab_foursquare";
    public static final String FAB_FREE_CODE_CAMP                 = "fab_free_code_camp";
    public static final String FAB_FREEBSD                        = "fab_freebsd";
    public static final String FAB_FULCRUM                        = "fab_fulcrum";
    public static final String FAB_GALACTIC_REPUBLIC              = "fab_galactic_republic";
    public static final String FAB_GALACTIC_SENATE                = "fab_galactic_senate";
    public static final String FAB_GET_POCKET                     = "fab_get_pocket";
    public static final String FAB_GG                             = "fab_gg";
    public static final String FAB_GG_CIRCLE                      = "fab_gg_circle";
    public static final String FAB_GIT                            = "fab_git";
    public static final String FAB_GIT_SQUARE                     = "fab_git_square";
    public static final String FAB_GITHUB                         = "fab_github";
    public static final String FAB_GITHUB_ALT                     = "fab_github_alt";
    public static final String FAB_GITHUB_SQUARE                  = "fab_github_square";
    public static final String FAB_GITKRAKEN                      = "fab_gitkraken";
    public static final String FAB_GITLAB                         = "fab_gitlab";
    public static final String FAB_GITTER                         = "fab_gitter";
    public static final String FAB_GLIDE                          = "fab_glide";
    public static final String FAB_GLIDE_G                        = "fab_glide_g";
    public static final String FAB_GOFORE                         = "fab_gofore";
    public static final String FAB_GOODREADS                      = "fab_goodreads";
    public static final String FAB_GOODREADS_G                    = "fab_goodreads_g";
    public static final String FAB_GOOGLE                         = "fab_google";
    public static final String FAB_GOOGLE_DRIVE                   = "fab_google_drive";
    public static final String FAB_GOOGLE_PLAY                    = "fab_google_play";
    public static final String FAB_GOOGLE_PLUS                    = "fab_google_plus";
    public static final String FAB_GOOGLE_PLUS_G                  = "fab_google_plus_g";
    public static final String FAB_GOOGLE_PLUS_SQUARE             = "fab_google_plus_square";
    public static final String FAB_GOOGLE_WALLET                  = "fab_google_wallet";
    public static final String FAB_GRATIPAY                       = "fab_gratipay";
    public static final String FAB_GRAV                           = "fab_grav";
    public static final String FAB_GRIPFIRE                       = "fab_gripfire";
    public static final String FAB_GRUNT                          = "fab_grunt";
    public static final String FAB_GULP                           = "fab_gulp";
    public static final String FAB_HACKER_NEWS                    = "fab_hacker_news";
    public static final String FAB_HACKER_NEWS_SQUARE             = "fab_hacker_news_square";
    public static final String FAB_HACKERRANK                     = "fab_hackerrank";
    public static final String FAB_HIPS                           = "fab_hips";
    public static final String FAB_HIRE_A_HELPER                  = "fab_hire_a_helper";
    public static final String FAB_HOOLI                          = "fab_hooli";
    public static final String FAB_HORNBILL                       = "fab_hornbill";
    public static final String FAB_HOTJAR                         = "fab_hotjar";
    public static final String FAB_HOUZZ                          = "fab_houzz";
    public static final String FAB_HTML5                          = "fab_html5";
    public static final String FAB_HUBSPOT                        = "fab_hubspot";
    public static final String FAB_IMDB                           = "fab_imdb";
    public static final String FAB_INSTAGRAM                      = "fab_instagram";
    public static final String FAB_INTERNET_EXPLORER              = "fab_internet_explorer";
    public static final String FAB_IOXHOST                        = "fab_ioxhost";
    public static final String FAB_ITUNES                         = "fab_itunes";
    public static final String FAB_ITUNES_NOTE                    = "fab_itunes_note";
    public static final String FAB_JAVA                           = "fab_java";
    public static final String FAB_JEDI_ORDER                     = "fab_jedi_order";
    public static final String FAB_JENKINS                        = "fab_jenkins";
    public static final String FAB_JOGET                          = "fab_joget";
    public static final String FAB_JOOMLA                         = "fab_joomla";
    public static final String FAB_JS                             = "fab_js";
    public static final String FAB_JS_SQUARE                      = "fab_js_square";
    public static final String FAB_JSFIDDLE                       = "fab_jsfiddle";
    public static final String FAB_KAGGLE                         = "fab_kaggle";
    public static final String FAB_KEYBASE                        = "fab_keybase";
    public static final String FAB_KEYCDN                         = "fab_keycdn";
    public static final String FAB_KICKSTARTER                    = "fab_kickstarter";
    public static final String FAB_KICKSTARTER_K                  = "fab_kickstarter_k";
    public static final String FAB_KORVUE                         = "fab_korvue";
    public static final String FAB_LARAVEL                        = "fab_laravel";
    public static final String FAB_LASTFM                         = "fab_lastfm";
    public static final String FAB_LASTFM_SQUARE                  = "fab_lastfm_square";
    public static final String FAB_LEANPUB                        = "fab_leanpub";
    public static final String FAB_LESS                           = "fab_less";
    public static final String FAB_LINE                           = "fab_line";
    public static final String FAB_LINKEDIN                       = "fab_linkedin";
    public static final String FAB_LINKEDIN_IN                    = "fab_linkedin_in";
    public static final String FAB_LINODE                         = "fab_linode";
    public static final String FAB_LINUX                          = "fab_linux";
    public static final String FAB_LYFT                           = "fab_lyft";
    public static final String FAB_MAGENTO                        = "fab_magento";
    public static final String FAB_MAILCHIMP                      = "fab_mailchimp";
    public static final String FAB_MANDALORIAN                    = "fab_mandalorian";
    public static final String FAB_MARKDOWN                       = "fab_markdown";
    public static final String FAB_MASTODON                       = "fab_mastodon";
    public static final String FAB_MAXCDN                         = "fab_maxcdn";
    public static final String FAB_MEDAPPS                        = "fab_medapps";
    public static final String FAB_MEDIUM                         = "fab_medium";
    public static final String FAB_MEDIUM_M                       = "fab_medium_m";
    public static final String FAB_MEDRT                          = "fab_medrt";
    public static final String FAB_MEETUP                         = "fab_meetup";
    public static final String FAB_MEGAPORT                       = "fab_megaport";
    public static final String FAB_MICROSOFT                      = "fab_microsoft";
    public static final String FAB_MIX                            = "fab_mix";
    public static final String FAB_MIXCLOUD                       = "fab_mixcloud";
    public static final String FAB_MIZUNI                         = "fab_mizuni";
    public static final String FAB_MODX                           = "fab_modx";
    public static final String FAB_MONERO                         = "fab_monero";
    public static final String FAB_NAPSTER                        = "fab_napster";
    public static final String FAB_NEOS                           = "fab_neos";
    public static final String FAB_NIMBLR                         = "fab_nimblr";
    public static final String FAB_NINTENDO_SWITCH                = "fab_nintendo_switch";
    public static final String FAB_NODE                           = "fab_node";
    public static final String FAB_NODE_JS                        = "fab_node_js";
    public static final String FAB_NPM                            = "fab_npm";
    public static final String FAB_NS8                            = "fab_ns8";
    public static final String FAB_NUTRITIONIX                    = "fab_nutritionix";
    public static final String FAB_ODNOKLASSNIKI                  = "fab_odnoklassniki";
    public static final String FAB_ODNOKLASSNIKI_SQUARE           = "fab_odnoklassniki_square";
    public static final String FAB_OLD_REPUBLIC                   = "fab_old_republic";
    public static final String FAB_OPENCART                       = "fab_opencart";
    public static final String FAB_OPENID                         = "fab_openid";
    public static final String FAB_OPERA                          = "fab_opera";
    public static final String FAB_OPTIN_MONSTER                  = "fab_optin_monster";
    public static final String FAB_OSI                            = "fab_osi";
    public static final String FAB_PAGE4                          = "fab_page4";
    public static final String FAB_PAGELINES                      = "fab_pagelines";
    public static final String FAB_PALFED                         = "fab_palfed";
    public static final String FAB_PATREON                        = "fab_patreon";
    public static final String FAB_PAYPAL                         = "fab_paypal";
    public static final String FAB_PENNY_ARCADE                   = "fab_penny_arcade";
    public static final String FAB_PERISCOPE                      = "fab_periscope";
    public static final String FAB_PHABRICATOR                    = "fab_phabricator";
    public static final String FAB_PHOENIX_FRAMEWORK              = "fab_phoenix_framework";
    public static final String FAB_PHOENIX_SQUADRON               = "fab_phoenix_squadron";
    public static final String FAB_PHP                            = "fab_php";
    public static final String FAB_PIED_PIPER                     = "fab_pied_piper";
    public static final String FAB_PIED_PIPER_ALT                 = "fab_pied_piper_alt";
    public static final String FAB_PIED_PIPER_HAT                 = "fab_pied_piper_hat";
    public static final String FAB_PIED_PIPER_PP                  = "fab_pied_piper_pp";
    public static final String FAB_PINTEREST                      = "fab_pinterest";
    public static final String FAB_PINTEREST_P                    = "fab_pinterest_p";
    public static final String FAB_PINTEREST_SQUARE               = "fab_pinterest_square";
    public static final String FAB_PLAYSTATION                    = "fab_playstation";
    public static final String FAB_PRODUCT_HUNT                   = "fab_product_hunt";
    public static final String FAB_PUSHED                         = "fab_pushed";
    public static final String FAB_PYTHON                         = "fab_python";
    public static final String FAB_QQ                             = "fab_qq";
    public static final String FAB_QUINSCAPE                      = "fab_quinscape";
    public static final String FAB_QUORA                          = "fab_quora";
    public static final String FAB_R_PROJECT                      = "fab_r_project";
    public static final String FAB_RAVELRY                        = "fab_ravelry";
    public static final String FAB_REACT                          = "fab_react";
    public static final String FAB_REACTEUROPE                    = "fab_reacteurope";
    public static final String FAB_README                         = "fab_readme";
    public static final String FAB_REBEL                          = "fab_rebel";
    public static final String FAB_RED_RIVER                      = "fab_red_river";
    public static final String FAB_REDDIT                         = "fab_reddit";
    public static final String FAB_REDDIT_ALIEN                   = "fab_reddit_alien";
    public static final String FAB_REDDIT_SQUARE                  = "fab_reddit_square";
    public static final String FAB_RENREN                         = "fab_renren";
    public static final String FAB_REPLYD                         = "fab_replyd";
    public static final String FAB_RESEARCHGATE                   = "fab_researchgate";
    public static final String FAB_RESOLVING                      = "fab_resolving";
    public static final String FAB_REV                            = "fab_rev";
    public static final String FAB_ROCKETCHAT                     = "fab_rocketchat";
    public static final String FAB_ROCKRMS                        = "fab_rockrms";
    public static final String FAB_SAFARI                         = "fab_safari";
    public static final String FAB_SASS                           = "fab_sass";
    public static final String FAB_SCHLIX                         = "fab_schlix";
    public static final String FAB_SCRIBD                         = "fab_scribd";
    public static final String FAB_SEARCHENGIN                    = "fab_searchengin";
    public static final String FAB_SELLCAST                       = "fab_sellcast";
    public static final String FAB_SELLSY                         = "fab_sellsy";
    public static final String FAB_SERVICESTACK                   = "fab_servicestack";
    public static final String FAB_SHIRTSINBULK                   = "fab_shirtsinbulk";
    public static final String FAB_SHOPWARE                       = "fab_shopware";
    public static final String FAB_SIMPLYBUILT                    = "fab_simplybuilt";
    public static final String FAB_SISTRIX                        = "fab_sistrix";
    public static final String FAB_SITH                           = "fab_sith";
    public static final String FAB_SKYATLAS                       = "fab_skyatlas";
    public static final String FAB_SKYPE                          = "fab_skype";
    public static final String FAB_SLACK                          = "fab_slack";
    public static final String FAB_SLACK_HASH                     = "fab_slack_hash";
    public static final String FAB_SLIDESHARE                     = "fab_slideshare";
    public static final String FAB_SNAPCHAT                       = "fab_snapchat";
    public static final String FAB_SNAPCHAT_GHOST                 = "fab_snapchat_ghost";
    public static final String FAB_SNAPCHAT_SQUARE                = "fab_snapchat_square";
    public static final String FAB_SOUNDCLOUD                     = "fab_soundcloud";
    public static final String FAB_SPEAKAP                        = "fab_speakap";
    public static final String FAB_SPOTIFY                        = "fab_spotify";
    public static final String FAB_SQUARESPACE                    = "fab_squarespace";
    public static final String FAB_STACK_EXCHANGE                 = "fab_stack_exchange";
    public static final String FAB_STACK_OVERFLOW                 = "fab_stack_overflow";
    public static final String FAB_STAYLINKED                     = "fab_staylinked";
    public static final String FAB_STEAM                          = "fab_steam";
    public static final String FAB_STEAM_SQUARE                   = "fab_steam_square";
    public static final String FAB_STEAM_SYMBOL                   = "fab_steam_symbol";
    public static final String FAB_STICKER_MULE                   = "fab_sticker_mule";
    public static final String FAB_STRAVA                         = "fab_strava";
    public static final String FAB_STRIPE                         = "fab_stripe";
    public static final String FAB_STRIPE_S                       = "fab_stripe_s";
    public static final String FAB_STUDIOVINARI                   = "fab_studiovinari";
    public static final String FAB_STUMBLEUPON                    = "fab_stumbleupon";
    public static final String FAB_STUMBLEUPON_CIRCLE             = "fab_stumbleupon_circle";
    public static final String FAB_SUPERPOWERS                    = "fab_superpowers";
    public static final String FAB_SUPPLE                         = "fab_supple";
    public static final String FAB_TEAMSPEAK                      = "fab_teamspeak";
    public static final String FAB_TELEGRAM                       = "fab_telegram";
    public static final String FAB_TELEGRAM_PLANE                 = "fab_telegram_plane";
    public static final String FAB_TENCENT_WEIBO                  = "fab_tencent_weibo";
    public static final String FAB_THE_RED_YETI                   = "fab_the_red_yeti";
    public static final String FAB_THEMECO                        = "fab_themeco";
    public static final String FAB_THEMEISLE                      = "fab_themeisle";
    public static final String FAB_THINK_PEAKS                    = "fab_think_peaks";
    public static final String FAB_TRADE_FEDERATION               = "fab_trade_federation";
    public static final String FAB_TRELLO                         = "fab_trello";
    public static final String FAB_TRIPADVISOR                    = "fab_tripadvisor";
    public static final String FAB_TUMBLR                         = "fab_tumblr";
    public static final String FAB_TUMBLR_SQUARE                  = "fab_tumblr_square";
    public static final String FAB_TWITCH                         = "fab_twitch";
    public static final String FAB_TWITTER                        = "fab_twitter";
    public static final String FAB_TWITTER_SQUARE                 = "fab_twitter_square";
    public static final String FAB_TYPO3                          = "fab_typo3";
    public static final String FAB_UBER                           = "fab_uber";
    public static final String FAB_UIKIT                          = "fab_uikit";
    public static final String FAB_UNIREGISTRY                    = "fab_uniregistry";
    public static final String FAB_UNTAPPD                        = "fab_untappd";
    public static final String FAB_USB                            = "fab_usb";
    public static final String FAB_USSUNNAH                       = "fab_ussunnah";
    public static final String FAB_VAADIN                         = "fab_vaadin";
    public static final String FAB_VIACOIN                        = "fab_viacoin";
    public static final String FAB_VIADEO                         = "fab_viadeo";
    public static final String FAB_VIADEO_SQUARE                  = "fab_viadeo_square";
    public static final String FAB_VIBER                          = "fab_viber";
    public static final String FAB_VIMEO                          = "fab_vimeo";
    public static final String FAB_VIMEO_SQUARE                   = "fab_vimeo_square";
    public static final String FAB_VIMEO_V                        = "fab_vimeo_v";
    public static final String FAB_VINE                           = "fab_vine";
    public static final String FAB_VK                             = "fab_vk";
    public static final String FAB_VNV                            = "fab_vnv";
    public static final String FAB_VUEJS                          = "fab_vuejs";
    public static final String FAB_WEEBLY                         = "fab_weebly";
    public static final String FAB_WEIBO                          = "fab_weibo";
    public static final String FAB_WEIXIN                         = "fab_weixin";
    public static final String FAB_WHATSAPP                       = "fab_whatsapp";
    public static final String FAB_WHATSAPP_SQUARE                = "fab_whatsapp_square";
    public static final String FAB_WHMCS                          = "fab_whmcs";
    public static final String FAB_WIKIPEDIA_W                    = "fab_wikipedia_w";
    public static final String FAB_WINDOWS                        = "fab_windows";
    public static final String FAB_WIX                            = "fab_wix";
    public static final String FAB_WIZARDS_OF_THE_COAST           = "fab_wizards_of_the_coast";
    public static final String FAB_WOLF_PACK_BATTALION            = "fab_wolf_pack_battalion";
    public static final String FAB_WORDPRESS                      = "fab_wordpress";
    public static final String FAB_WORDPRESS_SIMPLE               = "fab_wordpress_simple";
    public static final String FAB_WPBEGINNER                     = "fab_wpbeginner";
    public static final String FAB_WPEXPLORER                     = "fab_wpexplorer";
    public static final String FAB_WPFORMS                        = "fab_wpforms";
    public static final String FAB_WPRESSR                        = "fab_wpressr";
    public static final String FAB_XBOX                           = "fab_xbox";
    public static final String FAB_XING                           = "fab_xing";
    public static final String FAB_XING_SQUARE                    = "fab_xing_square";
    public static final String FAB_Y_COMBINATOR                   = "fab_y_combinator";
    public static final String FAB_YAHOO                          = "fab_yahoo";
    public static final String FAB_YANDEX                         = "fab_yandex";
    public static final String FAB_YANDEX_INTERNATIONAL           = "fab_yandex_international";
    public static final String FAB_YELP                           = "fab_yelp";
    public static final String FAB_YOAST                          = "fab_yoast";
    public static final String FAB_YOUTUBE                        = "fab_youtube";
    public static final String FAB_YOUTUBE_SQUARE                 = "fab_youtube_square";
    public static final String FAB_ZHIHU                          = "fab_zhihu";
